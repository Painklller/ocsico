...
/* Search settings */
<?php
$_hov_cwidth = $style['fss_hover_columns'] * $style['fss_column_width'] + 8;
$_blc_cwidth = $style['fss_block_columns'] * $style['fss_column_width'] + 8;
?>
<?php if ($use_compatibility == true): ?>
...
<?php echo $asp_set_ids; ?>.searchsettings  {
  ...
  max-width: <?php echo ( $style['fss_hover_columns'] == "auto") ? 'none' : $_hov_cwidth."px"; ?>;
...
<?php echo $asp_bset_ids; ?>.searchsettings {
  max-width: <?php echo ( $style['fss_block_columns'] == "auto") ? 'none' : $_blc_cwidth."px"; ?>;
}
