...
(function ($) {
    ...
    var methods = {
        ...
        initEtc: function() {
            ...
            $('div.asp_option', $this.n.searchsettings).on('click', function(e){
                //e.stopPropagation();
                //e.preventDefault();
                $('input[type="checkbox"]', this).prop("checked", !$('input[type="checkbox"]', this).prop("checked"));
                $('input[type="checkbox"]', this).change();
                return false;
            });
            ...
            $('.asp_option_cat input[type="checkbox"]', $this.n.searchsettings).change(function(e){
                var className = $(this).data("targetclass");
                $("input." + className, $this.n.searchsettings).prop("checked", $(this).prop("checked"));
            });

            // Category level automatic checking
            $('.asp_option_cat input[type="checkbox"]', $this.n.searchsettings).change(function(){
                var _this = $(this);
                var parent = $(this).parent();
                var i = 0;
        ...
        initMagnifierEvent: function () {
            ...
            $this.n.promagnifier.add($this.n.text).bind('click keyup', function (e) {
                ...
                if (
                    $this.n.text.val().length > 0 && $this.n.text.val().length >= $this.o.charcount && (
        ...
        initOverlayEvent: function () {
            ...
            if ($this.o.resultstype == "isotopic") {
                if ($this.o.iishowOverlay) {
                    ...
                    $this.n.resultsDiv.on('mouseup', '.asp_item_overlay', function(e){
        ...
        addAnimation: function () {
            ...
            if ($this.call_num > 0 || $this._no_animations == true) {
        ...
        searchRedirect: function( phrase ) {
            ...
            if ( typeof instData[rid] != 'undefined' ) {
                var $this = instData[rid];
                var url = $this.o.redirect_url.replace('{phrase}', phrase);
