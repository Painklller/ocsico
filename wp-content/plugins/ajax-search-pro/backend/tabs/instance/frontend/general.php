...
<div class="item">
    <?php
    $o = new wpdreamsYesNo("showexactmatches", "Show exact matches selector?", $sd['showexactmatches']);
    $params[$o->getName()] = $o->getData();
...
<div class="item">
    <?php
    $o = new wpdreamsYesNo("showsearchintitle", "Show search in title selector?", $sd['showsearchintitle']);
    $params[$o->getName()] = $o->getData();
...
<div class="item">
    <?php
    $o = new wpdreamsYesNo("showsearchincontent", "Show search in content selector?", $sd['showsearchincontent']);
    $params[$o->getName()] = $o->getData();
...
<div class="item">
    <?php
    $o = new wpdreamsYesNo("showsearchincomments", "Show search in comments selector?", $sd['showsearchincomments']);
    $params[$o->getName()] = $o->getData();
    $o = new wpdreamsText("searchincommentstext", "Text", $sd['searchincommentstext']);
    $params[$o->getName()] = $o->getData();
    ?>
</div>
<div class="item">
    <?php
    $o = new wpdreamsYesNo("showsearchinexcerpt", "Show search in excerpt selector?", $sd['showsearchinexcerpt']);
    $params[$o->getName()] = $o->getData();
    $o = new wpdreamsText("searchinexcerpttext", "Text", $sd['searchinexcerpttext']);
    $params[$o->getName()] = $o->getData();
    ?>
</div>