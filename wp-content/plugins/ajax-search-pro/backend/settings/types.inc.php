...
if (!function_exists("admin_scriptsV04")) {
    function admin_scriptsV04() {
        ...
        wp_register_script('wpdreams-types', ASP_URL . 'backend/settings/assets/types.js',
            array('jquery', 'jquery-ui-sortable', 'farbtastic'), ASP_CURR_VER_STRING, true
        );
        ...
        wp_register_script('wpdreams-ui-datetimepicker', ASP_URL . 'backend/settings/assets/js/ui/jquery.ui.datetimepicker.js', array(
            'jquery-ui-datepicker'
        ), ASP_CURR_VER_STRING, true);
        wp_enqueue_script('wpdreams-ui-datetimepicker');
        wp_register_script('wpdreams-tabs', ASP_URL . 'backend/settings/assets/tabs.js', array(
            'jquery'
        ), ASP_CURR_VER_STRING, true);
        wp_enqueue_script('wpdreams-tabs');
        wp_register_script('wpdreams-misc', ASP_URL . 'backend/settings/assets/misc.js', array(
            'jquery'
        ), ASP_CURR_VER_STRING, true);
        wp_enqueue_script('wpdreams-misc');

        wp_register_script('wpdreams-upload', ASP_URL . 'backend/settings/assets/upload.js', array(
            'jquery',
            'media-upload',
            'thickbox'
        ), ASP_CURR_VER_STRING, true);
        ...
        wp_register_script('wpdreams-spectrum', ASP_URL . 'backend/settings/assets/js/spectrum/spectrum.js', array(
            'jquery'
        ), ASP_CURR_VER_STRING, true);
        wp_enqueue_script('wpdreams-spectrum');

        wp_register_script('wpdreams-fonts-jsapi', '//ajax.googleapis.com/ajax/libs/webfont/1.4.7/webfont.js', array('jquery'), ASP_CURR_VER_STRING, true);
        wp_enqueue_script('wpdreams-fonts-jsapi');

        wp_register_script('wpdreams-fonts', ASP_URL . 'backend/settings/assets/fonts.js', array(
            'jquery',
            'media-upload',
            'thickbox'
        ), ASP_CURR_VER_STRING, true);
...
if (!function_exists("admin_stylesV04")) {
    function admin_stylesV04() {
        wp_register_style('wpdreams-style', ASP_URL . 'backend/settings/assets/style.css', array('wpdreams-tabs'), ASP_CURR_VER_STRING);
        ...
        wp_register_style('wpdreams-tabs', ASP_URL . 'backend/settings/assets/tabs.css');
        wp_enqueue_style('wpdreams-tabs');
        wp_register_style('wpdreams-accordion', ASP_URL . 'backend/settings/assets/accordion.css');
        wp_enqueue_style('wpdreams-accordion');
        wp_register_style('wpdreams-spectrum', ASP_URL . 'backend/settings/assets/js/spectrum/spectrum.css');
        wp_enqueue_style('wpdreams-spectrum');

        wp_enqueue_style('wpdreams_animations', ASP_URL . 'css/animations.css', array(), ASP_CURR_VER_STRING);
        wp_register_style('wpdreams-validator', ASP_URL . 'backend/settings/assets/validator.min.css');
